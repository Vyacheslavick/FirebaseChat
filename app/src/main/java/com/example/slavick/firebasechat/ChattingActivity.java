...
public class ChattingActivity extends AppCompatActivity {
    ...
    private void displayChatMessages() {
        ...
        Query query = FirebaseDatabase.getInstance().getReference().child("chatting").child("message");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.send).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                FirebaseDatabase.getInstance().getReference().child("chatting").child("message").push().setValue(new Message(FirebaseAuth.getInstance()
